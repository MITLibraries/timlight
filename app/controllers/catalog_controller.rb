...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.repository_class = Mit::Timdex::Repository
    #
    ## Class for converting Blacklight's url parameters to into request parameters for the search index
    # config.search_builder_class = Mit::Timdex::SearchBuilder
    #
    ## Model that maps search index responses to the blacklight response model
    config.response_model = Mit::Timdex::Response
    #
    ...
    config.add_show_field 'alternate_titles', label: 'alternate_titles'
    config.add_show_field 'call_numbers', label: 'call_numbers'
    ...
    config.add_show_field 'dois', label: 'dois'
    ...
    config.add_show_field 'holdings', label: 'holdings'

    config.add_show_field 'in_bibliography', label: 'in_bibliography'
    config.add_show_field 'literary_form', label: 'literary_form'
    config.add_show_field 'numbering', label: 'numbering'
    config.add_show_field 'oclcs', label: 'oclcs'
    config.add_show_field 'place_of_publication', label: 'place_of_publication'
    config.add_show_field 'related_items', label: 'related_items'
    config.add_show_field 'related_place', label: 'related_place'
